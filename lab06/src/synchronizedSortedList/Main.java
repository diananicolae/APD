...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N_ITERATIONS; i++) {
            ...
            threads[0] = new Reader("elemente1.txt", sList, semaphore);
            threads[1] = new Reader("elemente2.txt", sList, semaphore);
            threads[2] = new Reader("elemente3.txt", sList, semaphore);
            threads[3] = new Sort(sList, semaphore);
